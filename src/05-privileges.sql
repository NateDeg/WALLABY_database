...
GRANT SELECT ON TABLE wallaby.run, wallaby.instance, wallaby.detection, wallaby.product, wallaby.source, wallaby.source_detection, wallaby.tag, wallaby.tag_source_detection, wallaby.comment, wallaby.external_conflict, wallaby.kinematic_model TO "wallaby_user";
...
GRANT SELECT ON TABLE wallaby.run, wallaby.instance, wallaby.detection, wallaby.product, wallaby.source, wallaby.source_detection, wallaby.tag, wallaby.tag_source_detection, wallaby.comment, wallaby.external_conflict, wallaby.kinematic_model TO "gavoadmin";
...
GRANT SELECT ON TABLE wallaby.run, wallaby.instance, wallaby.detection, wallaby.product, wallaby.source, wallaby.source_detection, wallaby.tag, wallaby.tag_source_detection, wallaby.comment, wallaby.external_conflict, wallaby.kinematic_model TO "gavo";
...
GRANT SELECT ON TABLE wallaby.run, wallaby.instance, wallaby.detection, wallaby.product, wallaby.source, wallaby.source_detection, wallaby.tag, wallaby.tag_source_detection, wallaby.comment, wallaby.external_conflict, wallaby.kinematic_model TO "untrusted";
